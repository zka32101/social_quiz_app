...
const kDefaultAvatars = [
  ...
  Avatar(
    ...
    nameJa: 'シマウマ',
    nameEn: 'Zebra',
    imageAsset: 'assets/avatars/avatar_5.png',
    isFree: false,
    priceCoins: 150,
  ),
  Avatar(
    ...
    nameJa: 'ライオン',
    nameEn: 'Lion',
    imageAsset: 'assets/avatars/avatar_6.png',
    isFree: false,
    priceCoins: 150,
  ),
  Avatar(
    ...
    nameJa: 'ペンギン',
    nameEn: 'Penguin',
    imageAsset: 'assets/avatars/avatar_7.png',
    isFree: false,
    priceCoins: 150,
  ),
  Avatar(
    ...
    nameJa: 'フラミンゴ',
    nameEn: 'Flamingo',
    imageAsset: 'assets/avatars/avatar_8.png',
    isFree: false,
    priceCoins: 150,
  ),
  Avatar(
    ...
    nameJa: 'パロット',
    nameEn: 'Parrot',
    imageAsset: 'assets/avatars/avatar_9.png',
    isFree: false,
    priceCoins: 150,
  ),
  Avatar(
    ...
    nameJa: 'ウサギ',
    nameEn: 'Rabbit',
    imageAsset: 'assets/avatars/avatar_10.png',
    isFree: false,
    priceCoins: 120,
  ),
  Avatar(
    ...
    nameJa: 'リス',
    nameEn: 'Squirrel',
    imageAsset: 'assets/avatars/avatar_11.png',
    isFree: false,
    priceCoins: 120,
  ),
  Avatar(
    ...
    nameJa: 'フクロウ',
    nameEn: 'Owl',
    imageAsset: 'assets/avatars/avatar_12.png',
    isFree: false,
    priceCoins: 120,
  ),
  Avatar(
    ...
    nameJa: 'ウニコーン',
    nameEn: 'Unicorn',
    imageAsset: 'assets/avatars/avatar_13.png',
    isFree: false,
    priceCoins: 200,
  ),
  Avatar(
    ...
    nameJa: 'ドラゴン',
    nameEn: 'Dragon',
    imageAsset: 'assets/avatars/avatar_14.png',
    isFree: false,
    priceCoins: 200,
  ),
  Avatar(
    ...
    nameJa: 'ロボット',
    nameEn: 'Robot',
    imageAsset: 'assets/avatars/avatar_15.png',
    isFree: false,
    priceCoins: 200,
  ),
  Avatar(
    ...
    nameJa: 'エイリアン',
    nameEn: 'Alien',
    imageAsset: 'assets/avatars/avatar_16.png',
    isFree: false,
    priceCoins: 200,
  ),
];
